...
def main():
    ...
    parser.add_argument('--output', type=str, default=None,
                        help='Path to save benchmark results (default: runs/bench/benchmark_YYYYMMDD_HHMMSS.json)')

    args = parser.parse_args()

    # Set default output path if not provided
    if args.output is None:
        # Create runs/bench directory if it doesn't exist
        ...
        args.output = output_dir / f"benchmark_{timestamp}.json"
